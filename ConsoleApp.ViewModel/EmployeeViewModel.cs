...
namespace ConsoleApp.ViewModel
{
    ...
    public class EmployeeViewModel
    {
        ...
        public EmployeeViewModel(IEmployeeRepository repository)
        {
            ...
            {
                mRepository.Add(new Employee(0, "Свиридов Владислав Сергеевич", "СЕО", 15000));
                mRepository.Add(new Employee(1, "Исмагилов Антон Русланович", "Программист", 1000));
                mRepository.Add(new Employee(2, "Еливанов Алексей Евгеньевич", "Инженер", 1200));
            }
        }
